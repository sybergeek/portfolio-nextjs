...
const AnimatedText = ({text, className=""} : {text: any, className: any}) => {
  return (
    ...
    overflow-hidden'>
      <motion.h1 className={`inline-block w-full text-dark font-bold capitalize text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl
      dark:bg-dark dark:text-light ${className}`}
      variants={quote}
      initial="initial"
      animate="animate">
        {
